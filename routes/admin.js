...
router.get('/categories', authenticate, async (req, res) => {
  try {
    ...
    res.json({ success: true, data: [
      {id:1,name:'Network Outage'},{id:2,name:'Platform'},{id:3,name:'Billing & Accounts'},
      {id:4,name:'Hardware & Equipment'},{id:5,name:'SLA Breach'},{id:6,name:'Access & Authentication'},
  ...
  try {
    ...
    await pool.query(
      `INSERT INTO role_permissions (role, permission, allowed)
       VALUES ($1,$2,$3) ON CONFLICT (role, permission) DO UPDATE SET allowed=$3`,
